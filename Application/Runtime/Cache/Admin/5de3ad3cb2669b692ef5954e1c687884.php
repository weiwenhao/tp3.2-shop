...
<div class="main-div">
    <form name="main_form" method="POST" action="/Admin/Attribute/edit/type_id/3/attr_id/10.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <input  type="text" name="attr_option_value" value="<?php echo $data['attr_option_value']; ?>" />
                </td>
            </tr>
            <tr>
                <td class="label">类型id：</td>
                <td>
