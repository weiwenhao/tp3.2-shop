			...
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						<li>
							<label for="">用户名：</label>
							<input type="text" class="txt" name="member_name" />
						...
						<li class="checkcode">
							...
							<img style="cursor: pointer;" src="<?php echo U('captcha');?>" alt="" onclick="this.src='<?php echo U('captcha');?>#'+Math.random();"/>
						</li>
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" name="must" class="chb"/> 我已阅读并同意《用户注册协议》
						</li>
						<li>
							<label for="">&nbsp;</label>
