...
<script type="text/javascript" src="/Public/Home/js/cart2.js"></script>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="address">
				...
				<div class="address_select none">
					...
					<form action="/Home/Order/add.html" method="post" id="address_form" name="address_form">
						<ul>
							<li>
		...
		<div class="fillin_ft">
			<a href="javascript:void(0);" onclick=" submit_form()"><span>提交订单</span></a>
